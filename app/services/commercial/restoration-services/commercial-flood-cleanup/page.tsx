...
const service = getServiceBySlug("commercial", "restoration-services", "commercial-flood-cleanup");
...
export default function ServiceDetailPage() {
  ...
  const crumbs = [
    ...
    { name: service.title, url: "https://flood.repair/services/commercial/restoration-services/commercial-flood-cleanup/" },
  ];
