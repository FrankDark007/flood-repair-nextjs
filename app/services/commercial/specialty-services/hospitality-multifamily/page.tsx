...
const service = getServiceBySlug("commercial", "specialty-services", "hospitality-multifamily");
...
export default function ServiceDetailPage() {
  ...
  const crumbs = [
    ...
    { name: service.title, url: "https://flood.repair/services/commercial/specialty-services/hospitality-multifamily/" },
  ];
