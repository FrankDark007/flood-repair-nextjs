...
const service = getServiceBySlug("commercial", "specialty-services", "healthcare-facilities");
...
export default function ServiceDetailPage() {
  ...
  const crumbs = [
    ...
    { name: service.title, url: "https://flood.repair/services/commercial/specialty-services/healthcare-facilities/" },
  ];
