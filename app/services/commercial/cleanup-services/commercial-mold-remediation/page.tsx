...
const service = getServiceBySlug("commercial", "cleanup-services", "commercial-mold-remediation");
...
export default function ServiceDetailPage() {
  ...
  const crumbs = [
    ...
    { name: service.title, url: "https://flood.repair/services/commercial/cleanup-services/commercial-mold-remediation/" },
  ];
