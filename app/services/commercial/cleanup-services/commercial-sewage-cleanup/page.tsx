...
const service = getServiceBySlug("commercial", "cleanup-services", "commercial-sewage-cleanup");
...
export default function ServiceDetailPage() {
  ...
  const crumbs = [
    ...
    { name: service.title, url: "https://flood.repair/services/commercial/cleanup-services/commercial-sewage-cleanup/" },
  ];
