...
const service = getServiceBySlug("commercial", "technical-services", "indoor-air-quality");
...
export default function ServiceDetailPage() {
  ...
  const crumbs = [
    ...
    { name: service.title, url: "https://flood.repair/services/commercial/technical-services/indoor-air-quality/" },
  ];
