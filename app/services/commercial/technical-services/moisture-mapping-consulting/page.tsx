...
const service = getServiceBySlug("commercial", "technical-services", "moisture-mapping-consulting");
...
export default function ServiceDetailPage() {
  ...
  const crumbs = [
    ...
    { name: service.title, url: "https://flood.repair/services/commercial/technical-services/moisture-mapping-consulting/" },
  ];
