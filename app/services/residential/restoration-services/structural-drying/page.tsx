...
const service = getServiceBySlug("residential", "restoration-services", "structural-drying");
...
export default function ServiceDetailPage() {
  ...
  const crumbs = [
    ...
    { name: service.title, url: "https://flood.repair/services/residential/restoration-services/structural-drying/" },
  ];
