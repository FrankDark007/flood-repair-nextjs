...
const service = getServiceBySlug("residential", "restoration-services", "burst-pipe-cleanup");
...
export default function ServiceDetailPage() {
  ...
  const crumbs = [
    ...
    { name: service.title, url: "https://flood.repair/services/residential/restoration-services/burst-pipe-cleanup/" },
  ];
