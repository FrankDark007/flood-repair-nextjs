...
const service = getServiceBySlug("residential", "restoration-services", "storm-damage-restoration");
...
export default function ServiceDetailPage() {
  ...
  const crumbs = [
    ...
    { name: service.title, url: "https://flood.repair/services/residential/restoration-services/storm-damage-restoration/" },
  ];
