...
const service = getServiceBySlug("residential", "specialty-services", "crawl-space-drying");
...
export default function ServiceDetailPage() {
  ...
  const crumbs = [
    ...
    { name: service.title, url: "https://flood.repair/services/residential/specialty-services/crawl-space-drying/" },
  ];
