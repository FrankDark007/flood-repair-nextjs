...
const service = getServiceBySlug("residential", "specialty-services", "roof-leak-water-damage");
...
export default function ServiceDetailPage() {
  ...
  const crumbs = [
    ...
    { name: service.title, url: "https://flood.repair/services/residential/specialty-services/roof-leak-water-damage/" },
  ];
