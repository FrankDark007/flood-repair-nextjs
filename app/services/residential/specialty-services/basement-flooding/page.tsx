...
const service = getServiceBySlug("residential", "specialty-services", "basement-flooding");
...
export default function ServiceDetailPage() {
  ...
  const crumbs = [
    ...
    { name: service.title, url: "https://flood.repair/services/residential/specialty-services/basement-flooding/" },
  ];
