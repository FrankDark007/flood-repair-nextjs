...
const service = getServiceBySlug("residential", "cleanup-services", "contents-cleaning-packout");
...
export default function ServiceDetailPage() {
  ...
  const crumbs = [
    ...
    { name: service.title, url: "https://flood.repair/services/residential/cleanup-services/contents-cleaning-packout/" },
  ];
