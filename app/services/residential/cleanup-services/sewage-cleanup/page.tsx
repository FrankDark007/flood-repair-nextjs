...
const service = getServiceBySlug("residential", "cleanup-services", "sewage-cleanup");
...
export default function ServiceDetailPage() {
  ...
  const crumbs = [
    ...
    { name: service.title, url: "https://flood.repair/services/residential/cleanup-services/sewage-cleanup/" },
  ];
