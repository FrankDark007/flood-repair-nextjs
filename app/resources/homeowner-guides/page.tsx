...
const resource = resources.find((item) => item.slug === "homeowner-guides");

export const metadata = resource
  ? buildMetadata({
      title: resource.title + " | Flood Doctor",
      description: resource.description,
      path: "/resources/homeowner-guides/",
    })
  : undefined;
...
export default function ResourcePage() {
  ...
  const crumbs = [
    ...
    { name: resource.title, url: "https://flood.repair/resources/homeowner-guides/" },
  ];
