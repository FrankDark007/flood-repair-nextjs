...
const resource = resources.find((item) => item.slug === "insurance-guide");

export const metadata = resource
  ? buildMetadata({
      title: resource.title + " | Flood Doctor",
      description: resource.description,
      path: "/resources/insurance-guide/",
    })
  : undefined;
...
export default function ResourcePage() {
  ...
  const crumbs = [
    ...
    { name: resource.title, url: "https://flood.repair/resources/insurance-guide/" },
  ];
