...
const post = blogPosts.find((item) => item.slug === "odor-removal-after-smoke-damage");

export const metadata = post
  ? buildMetadata({
      title: post.title + " | Flood Doctor",
      description: post.description,
      path: "/blog/odor-removal-after-smoke-damage/",
    })
  : undefined;
...
export default function BlogPostPage() {
  ...
  const crumbs = [
    ...
    { name: post.title, url: "https://flood.repair/blog/odor-removal-after-smoke-damage/" },
  ];
  ...
  const blogSchema = {
    ...
    mainEntityOfPage: "https://flood.repair/blog/odor-removal-after-smoke-damage/",
  };
