...
const post = blogPosts.find((item) => item.slug === "insurance-claims-restoration-docs");

export const metadata = post
  ? buildMetadata({
      title: post.title + " | Flood Doctor",
      description: post.description,
      path: "/blog/insurance-claims-restoration-docs/",
    })
  : undefined;
...
export default function BlogPostPage() {
  ...
  const crumbs = [
    ...
    { name: post.title, url: "https://flood.repair/blog/insurance-claims-restoration-docs/" },
  ];
  ...
  const blogSchema = {
    ...
    mainEntityOfPage: "https://flood.repair/blog/insurance-claims-restoration-docs/",
  };
