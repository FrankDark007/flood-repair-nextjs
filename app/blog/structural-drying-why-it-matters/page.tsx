...
const post = blogPosts.find((item) => item.slug === "structural-drying-why-it-matters");

export const metadata = post
  ? buildMetadata({
      title: post.title + " | Flood Doctor",
      description: post.description,
      path: "/blog/structural-drying-why-it-matters/",
    })
  : undefined;
...
export default function BlogPostPage() {
  ...
  const crumbs = [
    ...
    { name: post.title, url: "https://flood.repair/blog/structural-drying-why-it-matters/" },
  ];
  ...
  const blogSchema = {
    ...
    mainEntityOfPage: "https://flood.repair/blog/structural-drying-why-it-matters/",
  };
