...
const post = blogPosts.find((item) => item.slug === "mold-remediation-warning-signs");

export const metadata = post
  ? buildMetadata({
      title: post.title + " | Flood Doctor",
      description: post.description,
      path: "/blog/mold-remediation-warning-signs/",
    })
  : undefined;
...
export default function BlogPostPage() {
  ...
  const crumbs = [
    ...
    { name: post.title, url: "https://flood.repair/blog/mold-remediation-warning-signs/" },
  ];
  ...
  const blogSchema = {
    ...
    mainEntityOfPage: "https://flood.repair/blog/mold-remediation-warning-signs/",
  };
