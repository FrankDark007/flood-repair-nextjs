...
const post = blogPosts.find((item) => item.slug === "storm-damage-restoration-checklist");

export const metadata = post
  ? buildMetadata({
      title: post.title + " | Flood Doctor",
      description: post.description,
      path: "/blog/storm-damage-restoration-checklist/",
    })
  : undefined;
...
export default function BlogPostPage() {
  ...
  const crumbs = [
    ...
    { name: post.title, url: "https://flood.repair/blog/storm-damage-restoration-checklist/" },
  ];
  ...
  const blogSchema = {
    ...
    mainEntityOfPage: "https://flood.repair/blog/storm-damage-restoration-checklist/",
  };
