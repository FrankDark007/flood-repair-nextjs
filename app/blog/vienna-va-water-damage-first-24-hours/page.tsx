...
const post = blogPosts.find((item) => item.slug === "vienna-va-water-damage-first-24-hours");

export const metadata = post
  ? buildMetadata({
      title: post.title + " | Flood Doctor",
      description: post.description,
      path: "/blog/vienna-va-water-damage-first-24-hours/",
    })
  : undefined;
...
export default function BlogPostPage() {
  ...
  const crumbs = [
    ...
    { name: post.title, url: "https://flood.repair/blog/vienna-va-water-damage-first-24-hours/" },
  ];
  ...
  const blogSchema = {
    ...
    mainEntityOfPage: "https://flood.repair/blog/vienna-va-water-damage-first-24-hours/",
  };
