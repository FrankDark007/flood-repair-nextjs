...
const post = blogPosts.find((item) => item.slug === "northern-virginia-flood-cleanup-safety");

export const metadata = post
  ? buildMetadata({
      title: post.title + " | Flood Doctor",
      description: post.description,
      path: "/blog/northern-virginia-flood-cleanup-safety/",
    })
  : undefined;
...
export default function BlogPostPage() {
  ...
  const crumbs = [
    ...
    { name: post.title, url: "https://flood.repair/blog/northern-virginia-flood-cleanup-safety/" },
  ];
  ...
  const blogSchema = {
    ...
    mainEntityOfPage: "https://flood.repair/blog/northern-virginia-flood-cleanup-safety/",
  };
