...
const post = blogPosts.find((item) => item.slug === "commercial-water-damage-minimize-downtime");

export const metadata = post
  ? buildMetadata({
      title: post.title + " | Flood Doctor",
      description: post.description,
      path: "/blog/commercial-water-damage-minimize-downtime/",
    })
  : undefined;
...
export default function BlogPostPage() {
  ...
  const crumbs = [
    ...
    { name: post.title, url: "https://flood.repair/blog/commercial-water-damage-minimize-downtime/" },
  ];
  ...
  const blogSchema = {
    ...
    mainEntityOfPage: "https://flood.repair/blog/commercial-water-damage-minimize-downtime/",
  };
